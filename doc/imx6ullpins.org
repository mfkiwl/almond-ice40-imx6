...
| CSI_DATA00        | E4         | NVCC_CSI      | GPIO      | ALT5         | GPIO4_IO21               | Input          | Keeper                  | SPI2 SCLK                                     | SPI             |
| CSI_DATA01        | E3         | NVCC_CSI      | GPIO      | ALT5         | GPIO4_IO22               | Input          | Keeper                  | SPI2 SS0                                      | SPI             |
| CSI_DATA02        | E2         | NVCC_CSI      | GPIO      | ALT5         | GPIO4_IO23               | Input          | Keeper                  | SPI2 MOSI                                     | SPI             |
| CSI_DATA03        | E1         | NVCC_CSI      | GPIO      | ALT5         | GPIO4_IO24               | Input          | Keeper                  | SPI2 MISO                                     | SPI             |
| CSI_DATA04        | D4         | NVCC_CSI      | GPIO      | ALT5         | GPIO4_IO25               | Input          | Keeper                  | SPI1 SCLK                                     | SPI             |
| CSI_DATA05        | D3         | NVCC_CSI      | GPIO      | ALT5         | GPIO4_IO26               | Input          | Keeper                  | SPI1 SS0                                      | SPI             |
| CSI_DATA06        | D2         | NVCC_CSI      | GPIO      | ALT5         | GPIO4_IO27               | Input          | Keeper                  | SPI1 MOSI                                     | SPI             |
| CSI_DATA07        | D1         | NVCC_CSI      | GPIO      | ALT5         | GPIO4_IO28               | Input          | Keeper                  | SPI1 MISO                                     | SPI             |
| CSI_HSYNC         | F3         | NVCC_CSI      | GPIO      | ALT5         | GPIO4_IO20               | Input          | Keeper                  |                                               | SPI             |
| CSI_MCLK          | F5         | NVCC_CSI      | GPIO      | ALT5         | GPIO4_IO17               | Input          | Keeper                  | ? EMMC card detect = VSS                      | SPI             |
| CSI_PIXCLK        | E5         | NVCC_CSI      | GPIO      | ALT5         | GPIO4_IO18               | Input          | Keeper                  | ? EMMC write protect = VSS                    | SPI             |
| CSI_VSYNC         | F2         | NVCC_CSI      | GPIO      | ALT5         | GPIO4_IO19               | Input          | Keeper                  |                                               | SPI             |
...
| ENET1_RX_DATA0    | F16        | NVCC_ENET     | GPIO      | ALT5         | GPIO2_IO0                | Input          | Keeper                  |                                               | ENET            |
| ENET1_RX_DATA1    | E17        | NVCC_ENET     | GPIO      | ALT5         | GPIO2_IO1                | Input          | Keeper                  |                                               | ENET            |
| ENET1_RX_EN       | E16        | NVCC_ENET     | GPIO      | ALT5         | GPIO2_IO2                | Input          | Keeper                  |                                               | ENET            |
| ENET1_RX_ER       | D15        | NVCC_ENET     | GPIO      | ALT5         | GPIO2_IO7                | Input          | Keeper                  |                                               | ENET            |
| ENET1_TX_CLK      | F14        | NVCC_ENET     | GPIO      | ALT5         | GPIO2_IO6                | Input          | Keeper                  |                                               | ENET            |
| ENET1_TX_DATA0    | E15        | NVCC_ENET     | GPIO      | ALT5         | GPIO2_IO3                | Input          | Keeper                  |                                               | ENET            |
...
| GPIO1_IO00        | K13        | NVCC_GPIO     | GPIO      | ALT5         | GPIO1_IO00               | Input          | Keeper                  | touch sense ADC / encoder                     | GPIO            |
| GPIO1_IO01        | L15        | NVCC_GPIO     | GPIO      | ALT5         | GPIO1_IO01               | Input          | Keeper                  | touch sense ADC / encoder                     | GPIO            |
| GPIO1_IO02        | L14        | NVCC_GPIO     | GPIO      | ALT5         | GPIO1_IO02               | Input          | Keeper                  | touch sense ADC / encoder                     | GPIO            |
| GPIO1_IO03        | L17        | NVCC_GPIO     | GPIO      | ALT5         | GPIO1_IO03               | Input          | Keeper                  | touch sense ADC / button                      | GPIO            |
| GPIO1_IO04        | M16        | NVCC_GPIO     | GPIO      | ALT5         | GPIO1_IO04               | Input          | Keeper                  | touch sense ADC                               | GPIO            |
| GPIO1_IO05        | M17        | NVCC_GPIO     | GPIO      | ALT5         | GPIO1_IO05               | Input          | Keeper                  | SD card V select (defined by boot 8.5.3.4)    | SDCARD          |
| GPIO1_IO06        | K17        | NVCC_GPIO     | GPIO      | ALT5         | GPIO1_IO06               | Input          | Keeper                  |                                               | GPIO            |
| GPIO1_IO07        | L16        | NVCC_GPIO     | GPIO      | ALT5         | GPIO1_IO07               | Input          | Keeper                  |                                               | GPIO            |
| GPIO1_IO08        | N17        | NVCC_GPIO     | GPIO      | ALT5         | GPIO1_IO08               | Input          | Keeper                  | PWM1 (backlight)                              | GPIO            |
...
| LCD_DATA16        | C13        | NVCC_LCD      | GPIO      | ALT5         | GPIO3_IO21               | Input          | Keeper                  |                                               | LCD             |
| LCD_DATA17        | B13        | NVCC_LCD      | GPIO      | ALT5         | GPIO3_IO22               | Input          | Keeper                  |                                               | LCD             |
| LCD_DATA18        | A13        | NVCC_LCD      | GPIO      | ALT5         | GPIO3_IO23               | Input          | Keeper                  |                                               | LCD             |
| LCD_DATA19        | D14        | NVCC_LCD      | GPIO      | ALT5         | GPIO3_IO24               | Input          | Keeper                  |                                               | LCD             |
| LCD_DATA20        | C14        | NVCC_LCD      | GPIO      | ALT5         | GPIO3_IO25               | Input          | Keeper                  |                                               | LCD             |
| LCD_DATA21        | B14        | NVCC_LCD      | GPIO      | ALT5         | GPIO3_IO26               | Input          | Keeper                  |                                               | LCD             |
| LCD_DATA22        | A14        | NVCC_LCD      | GPIO      | ALT5         | GPIO3_IO27               | Input          | Keeper                  |                                               | LCD             |
| LCD_DATA23        | B16        | NVCC_LCD      | GPIO      | ALT5         | GPIO3_IO28               | Input          | Keeper                  |                                               | LCD             |
...
| NAND_CE0_B        | C5         | NVCC_NAND     | GPIO      | ALT5         | GPIO4_IO13               | Input          | Keeper                  |                                               | EMMC            |
| NAND_CE1_B        | B5         | NVCC_NAND     | GPIO      | ALT5         | GPIO4_IO14               | Input          | Keeper                  |                                               | EMMC            |
| NAND_CLE          | A4         | NVCC_NAND     | GPIO      | ALT5         | GPIO4_IO15               | Input          | Keeper                  |                                               | EMMC            |
...
| NAND_DQS          | E6         | NVCC_NAND     | GPIO      | ALT5         | GPIO4_IO16               | Input          | Keeper                  |                                               | EMMC            |
| NAND_RE_B         | D8         | NVCC_NAND     | GPIO      | ALT5         | GPIO4_IO0                | Input          | Keeper                  | EMMC                                          | EMMC            |
| NAND_READY_B      | A3         | NVCC_NAND     | GPIO      | ALT5         | GPIO4_IO12               | Input          | Keeper                  |                                               | EMMC            |
| NAND_WE_B         | C8         | NVCC_NAND     | GPIO      | ALT5         | GPIO4_IO1                | Input          | Keeper                  | EMMC                                          | EMMC            |
| NAND_WP_B         | D5         | NVCC_NAND     | GPIO      | ALT5         | GPIO4_IO11               | Input          | Keeper                  |                                               | EMMC            |
...
| SNVS_TAMPER0      | R10        | VDD_SNVS_IN   | GPIO      | ALT5         | GPIO5_IO00/SNVS_TAMPER01 | Input          | Keeper/Not connected1,2 |                                               | CONTROL         |
| SNVS_TAMPER1      | R9         | VDD_SNVS_IN   | GPIO      | ALT5         | GPIO5_IO01/SNVS_TAMPER11 | Input          | Keeper/Not connected1,2 |                                               | CONTROL         |
| SNVS_TAMPER2      | P11        | VDD_SNVS_IN   | GPIO      | ALT5         | GPIO5_IO02/SNVS_TAMPER21 | Input          | Keeper/Not connected1,2 |                                               | CONTROL         |
| SNVS_TAMPER3      | P10        | VDD_SNVS_IN   | GPIO      | ALT5         | GPIO5_IO03/SNVS_TAMPER31 | Input          | Keeper/Not connected1,2 |                                               | CONTROL         |
| SNVS_TAMPER4      | P9         | VDD_SNVS_IN   | GPIO      | ALT5         | GPIO5_IO04/SNVS_TAMPER41 | Input          | Keeper/Not connected1,2 |                                               | CONTROL         |
| SNVS_TAMPER5      | N8         | VDD_SNVS_IN   | GPIO      | ALT5         | GPIO5_IO05/SNVS_TAMPER51 | Input          | Keeper/Not connected1,2 |                                               | CONTROL         |
| SNVS_TAMPER6      | N11        | VDD_SNVS_IN   | GPIO      | ALT5         | GPIO5_IO06/SNVS_TAMPER61 | Input          | Keeper/Not connected1,2 |                                               | CONTROL         |
| SNVS_TAMPER7      | N10        | VDD_SNVS_IN   | GPIO      | ALT5         | GPIO5_IO07/SNVS_TAMPER71 | Input          | Keeper/Not connected1,2 |                                               | CONTROL         |
| SNVS_TAMPER8      | N9         | VDD_SNVS_IN   | GPIO      | ALT5         | GPIO5_IO08/SNVS_TAMPER81 | Input          | Keeper/Not connected1,2 |                                               | CONTROL         |
| SNVS_TAMPER9      | R6         | VDD_SNVS_IN   | GPIO      | ALT5         | GPIO5_IO09/SNVS_TAMPER91 | Input          | Keeper/Not connected1,2 |                                               | CONTROL         |
...
| UART3_CTS_B       | H15        | NVCC_UART     | GPIO      | ALT5         | GPIO1_IO26               | Input          | Keeper                  |                                               | UART            |
| UART3_RTS_B       | G14        | NVCC_UART     | GPIO      | ALT5         | GPIO1_IO27               | Input          | Keeper                  |                                               | UART            |
| UART3_RX_DATA     | H16        | NVCC_UART     | GPIO      | ALT5         | GPIO1_IO25               | Input          | Keeper                  |                                               | UART            |
| UART3_TX_DATA     | H17        | NVCC_UART     | GPIO      | ALT5         | GPIO1_IO24               | Input          | Keeper                  |                                               | UART            |
| UART4_RX_DATA     | G16        | NVCC_UART     | GPIO      | ALT5         | GPIO1_IO29               | Input          | Keeper                  | I2C1                                          | UART            |
| UART4_TX_DATA     | G17        | NVCC_UART     | GPIO      | ALT5         | GPIO1_IO28               | Input          | Keeper                  | I2C1                                          | UART            |
| UART5_RX_DATA     | G13        | NVCC_UART     | GPIO      | ALT5         | GPIO1_IO31               | Input          | Keeper                  | I2C2                                          | UART            |
| UART5_TX_DATA     | F17        | NVCC_UART     | GPIO      | ALT5         | GPIO1_IO30               | Input          | Keeper                  | I2C2                                          | UART            |
...
| DRAM_VREF         | P4         | DRAM_VREF     | POWER     | POWER        |                          |                |                         |                                               | DDR             |
| GPANAIO           | R13        | GPANAIO       | POWER     | POWER        |                          |                |                         |                                               | POWER           |
| NVCC_CSI          | F4         | NVCC_CSI      | POWER     | POWER        |                          |                |                         |                                               | SPI             |
| NVCC_DRAM         | G6         | NVCC_DRAM     | POWER     | POWER        |                          |                |                         |                                               | DDR             |
| NVCC_DRAM         | H6         | NVCC_DRAM     | POWER     | POWER        |                          |                |                         |                                               | DDR             |
| NVCC_DRAM         | J6         | NVCC_DRAM     | POWER     | POWER        |                          |                |                         |                                               | DDR             |
| NVCC_DRAM         | K6         | NVCC_DRAM     | POWER     | POWER        |                          |                |                         |                                               | DDR             |
| NVCC_DRAM         | L6         | NVCC_DRAM     | POWER     | POWER        |                          |                |                         |                                               | DDR             |
| NVCC_DRAM         | M6         | NVCC_DRAM     | POWER     | POWER        |                          |                |                         |                                               | DDR             |
| NVCC_DRAM_2P5     | N6         | NVCC_DRAM_2P5 | POWER     | POWER        |                          |                |                         |                                               | DDR             |
| NVCC_ENET         | F13        | NVCC_ENET     | POWER     | POWER        |                          |                |                         |                                               | ENET            |
| NVCC_GPIO         | J13        | NVCC_GPIO     | POWER     | POWER        |                          |                |                         |                                               | GPIO            |
| NVCC_LCD          | E13        | NVCC_LCD      | POWER     | POWER        |                          |                |                         |                                               | LCD             |
| NVCC_NAND         | E7         | NVCC_NAND     | POWER     | POWER        |                          |                |                         |                                               | EMMC            |
| NVCC_PLL          | P13        | NVCC_PLL      | POWER     | POWER        |                          |                |                         |                                               | POWER           |
| NVCC_SD1          | C4         | NVCC_SD       | POWER     | POWER        |                          |                |                         |                                               | SDCARD          |
| NVCC_UART         | H13        | NVCC_UART     | POWER     | POWER        |                          |                |                         |                                               | UART            |
...
| VDD_SOC_IN        | K10        | VDD_SOC_IN    | POWER     | POWER        |                          |                |                         |                                               | POWER           |
